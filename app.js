...
app.use(cors({
  "origin": ["http://localhost:3000","http://localhost:5000","http://localhost:3001"],  //允许所有前端域名
  "credentials":true,//允许携带凭证
  "methods": "GET,HEAD,PUT,PATCH,POST,DELETE", //被允许的提交方式
  "allowedHeaders":['Content-Type','Access-Control-Allow-Origin']//被允许的post方式的请求头
}));
...
app.use('/api/getcart',require('./routes/api/getcart'))
app.use('/api/getmes',require('./routes/api/getmes'))
